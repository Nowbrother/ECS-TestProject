...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	void ExecuteSingle(int globalBoneIndex)
	{
		...
		{
			outBlendedBones[globalBoneIndex] = rb.refPose;
			return;
		}
		...
		var refPosWeight = CalculateFinalLayerWeights(layerWeights, animationsToProcess, rb.hash);
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	public static float CalculateFinalLayerWeights(in Span<float> layerWeights, in DynamicBuffer<AnimationToProcessComponent> atp, in Hash128 boneHash)
	{
		var layerIndex = -1;
		var w = 1.0f;
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	unsafe public void Execute(in ArchetypeChunk chunk, int unfilteredChunkIndex, bool useEnabledMask, in v128 chunkEnabledMask)
	{
		...
		while (cee.NextEntityIndex(out var i))
		{
			...
			ComputeBoneAnimationJob.CalculateFinalLayerWeights(layerWeights, animationsToProcess, new Hash128());
